...
struct PlayerData playerData[5]; // Array untuk menyimpan data pemain
...
void showMenu();
void checkCollision();
void sortScores(); // Fungsi untuk mengurutkan skor pemain
...
int main()
{
    ...
    for (currentPlayer = 0; currentPlayer < numPlayers; currentPlayer++)
    {
        ...
        sortScores(); // Panggil fungsi untuk mengurutkan skor pemain

        // Tampilkan lima skor teratas
        printf("\nTop 5 Scores:\n");
        for (i = 0; i < 5; i++)
        {
...
void sortScores() {
    ...
    // Bubble sort untuk mengurutkan skor
    for (i = 0; i < 5 - 1; i++) {
        for (j = 0; j < 5 - i - 1; j++) {
